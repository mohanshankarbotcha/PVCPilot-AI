      ...
      <div className="min-h-screen bg-zinc-950 text-white flex items-center justify-center relative overflow-hidden px-4">
        ...
        >
          ...
          <div className="mt-8 pt-6 border-t border-zinc-800 text-center text-xs text-zinc-500">
            CREATED BY BMS · PVCPilot AI © 2026
          </div>
        </motion.div>
      </div>
    );
          ...
          <div className="py-4 border-t border-sidebar-border text-center">
            {sidebarOpen ? (
              <div className="rounded-lg bg-muted/40 px-3 py-2 text-center mx-3">
                <p className="text-[10px] text-muted-foreground font-medium">Made with ♥ by <span className="text-primary font-semibold">BMS</span></p>
                <p className="text-[9px] text-muted-foreground/60 mt-0.5">PVCPilot AI © 2026</p>
              </div>
            ) : (
              <p className="text-[10px] text-primary font-bold font-mono">BMS</p>
            )}
          </div>
        </aside>
